...
if (globalThis.__OWLS_INTERFACES_URL__ && globalThis.__OWLS_INTERFACES_URL__ !== interfacesUrl) throw new Error('A different OWLS interface release already owns this document');
...
const release = coordinator.register({
  schemaVersion: 2, appId, release: `marketing-probe-${LOADER_COMMIT.slice(0, 12)}`,
  runtime: 'raw-wasm', entrypoint: 'probe',
